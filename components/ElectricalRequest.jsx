...
const ElectricalRequest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "electrical_requests"), {
      ...
      setElectricalItem("");
      setReason("");
      alert("Electrical request submitted successfully!");
    } catch (error) {
      console.error("Error submitting electrical request:", error);
      alert("Failed to submit electrical request. Please try again.");
    }
    ...
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input
            type="text"
            value={electricalItem}
            onChange={(e) => setElectricalItem(e.target.value)}
...
export default ElectricalRequest;
