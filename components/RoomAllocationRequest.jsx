...
const RoomAllocationRequest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "room_allocation_requests"), {
        studentId: currentUser.uid,
        studentName: userProfile.fullName,
        currentRoomNo: userProfile.roomNo,
        newRoomNo,
        reason,
        status: "pending",
      ...
      alert("Failed to submit room allocation request. Please try again.");
    }
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">
        Request Room Allocation Change
      </h2>
