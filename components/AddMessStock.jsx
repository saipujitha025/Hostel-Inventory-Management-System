...
const AddMessStock = () => {
    ...
    try {
      ...
      if (itemDocId) {
        ...
        await updateDoc(itemDocRef, {
          ...
          price: Number(price),
          duration: Number(duration), // Add duration to existing item
          imageUrl:
            imageUrl ||
        ...
        await addDoc(itemsCollection, {
          ...
          alertThreshold: Number(alertThreshold),
          price: Number(price),
          duration: Number(duration), // Add duration to new item
          imageUrl,
        });
      }
      ...
      setImage(null);
      alert("Mess stock item added successfully!");
    } catch (error) {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-semibold mb-4">Add New Mess Stock Item</h2>
