...
const ElectricalAllocation = () => {
  const { rooms, electricalStock, fetchStock, users } =
  ...
  const handleAllocate = async () => {
    const item = electricalStock.find((item) => item.id === selectedItem);
  ...
  return (
    <div className="p-6 bg-gray-100 rounded-lg shadow-md">
      ...
      <div className="mt-6">
        <StockDisplay category="electrical" />
      </div>
    </div>
  );
};

export default ElectricalAllocation;
